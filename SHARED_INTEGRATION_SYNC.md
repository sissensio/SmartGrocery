...
| **2026-06-01 21:10** | Antigravity | `store_georeferencing_lifecycle_design.md`, `SHARED_INTEGRATION_SYNC.md` | **Gestione Ciclo di Vita e GPS Negozi**: Disegnata la specifica per la localizzazione GPS dei negozi a costo zero (Android Geocoder locale + Nominatim OSM fallback) e l'anagrafica dei negozi personali (non certificati) auto-arricchibili in-situ. Definite le logiche anti-duplicazione inline durante le scansioni OCR e il protocollo atomico di re-associazione cascata delle spese all'atto della cancellazione di un negozio. | ✅ Sincronizzato & Verificato |
